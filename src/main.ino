...
void getMemoryUsage()
{
    if (getNetDataInfo("mem.available", netChartData))
    {
        ...
        mem_usage = 100 * (1.0 - netChartData.max / 3749.0);
    }
}
...
{
    if (getNetDataInfoWithDimension("net.eth1", netChartData, "received"))
    {
...
void getNetworkSent()
{
    if (getNetDataInfoWithDimension("net.eth1", netChartData, "sent"))
    {
        Serial.print("Sent: ");
...
void getTemperature()
{
    if (getNetDataInfo("sensors.temp_thermal_zone0_hwmon_hwmon0", netChartData))
    {
